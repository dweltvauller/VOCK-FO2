# Zaius — Voice Actor Script
**Character:** Zaius, Mine Foreman, Broken Hills (hczaius)
**Total recordable lines:** 40 (ZAIUS1–ZAIUS50, non-sequential — see footer for excluded lines)
...
> Lines marked PC are for context only — do not record. Low-INT PC lines are grunts/nonsense; Zaius responds to them but never speaks them himself. **Three lines are engine macros and are NOT recordable as written** — the game concatenates a currency prefix and a dynamic dollar amount around them at runtime. These are flagged individually below; Fede needs to decide how to handle them (fixed-value lines, or pre/post segment recording) before they can be scripted for a VA session.
...
## Polite Transition
*A brief bridge line the engine can concatenate with ZAIUS4 if the PC gave a charming/polite greeting first. Can be recorded standalone.*
...
ZAIUS7: Ha. Ha. Funny. Nothing better than a smart guy to solve a problem.
...
ZAIUS8: Our air purifier's broken. It's on the bottom level. We've got no parts, and we've got no protective equipment. Without the parts, we can't fix it. Without the protection, the radon gas'll nail us. Are you any good with your hands?
...
ZAIUS14: Izzat so? Well, my brainy friend, why not fix the air purifier down below? You'll need the parts, and you'll need to find a way to breathe the gas. Until you can show me you can do that, I think I'll just assume the only thing smart about you is your mouth.
...
ZAIUS15: The main problem is that I'm an idiot. I'm repeating this because I don't believe that your asshole just spouted something that sounded like words. Get out of my sight, maggot.

## Aggressive Quest Loop
*Still bristling. Delivers the quest info with a sharp edge and a taunt.*

ZAIUS16: Aside from the jerks who keep harassing me, the problem is the air purifier in the mine. It's busted, and we don't have the protective gear to breathe the radon and we don't have the parts to fix it. You can, though, right? Because you're so smart?

## Barter / Reward Negotiation
**Engine macro — not recordable as-is.** The game constructs the full sentence at runtime by concatenating a currency prefix ("[Counts $" + a dynamic dollar amount) with this suffix string. Flag for Fede: needs a decision on pre/post segment recording or a fixed-value replacement.

ZAIUS17: "] How's that sound?" *(preceded at runtime by "[Counts $<AMOUNT>"; also reused verbatim for two other quest states)*
...
ZAIUS18: Great! You'll need the parts, of course. Go to New Reno and look for Renesco. He's got tools lying around the shop. Tell him Zaius sent you. Tell him that I said, "The canary's kicked the bucket." I don't know where to get protective equipment for the gas. I suppose you could go in without any but you'll be hurting. Again, thank you.

## Deferral / Rejection Loop
*Accepts it — a little resigned.*

ZAIUS19: No? Well, if you should change your mind, you know where to find me.

## Half-Pay Retainer Dispatch
**Engine macro — not recordable as-is.** Constructed at runtime as "[Counts $<AMOUNT>" + dynamic amount + this suffix.

ZAIUS20: " and gives you half] I'll give you the other half when you're done. Go to New Reno and look for Renesco. He's got tools just lying around his office. He should be able to help you with the parts."

## Firm Barter Limit
*PC has pushed the barter too far. Flat, final.*

ZAIUS21: Sorry. That's the limit. Take it or leave it.

## Walking Away From Barter
*PC chose to leave without a deal. Dry, dismissive, not broken up about it.*

ZAIUS22: Fine. Leave it, then. No thanks.
...
ZAIUS31: You changed your mind about trying to fix the mine yet?

## Progress Check-In
*PC has taken the job; Zaius checks in. Gently urgent.*

ZAIUS32: How's it coming? I hope you're going to take care of this soon...

## Delivery Phase — Parts Confirmed
*Used at two different quest states — one recorded take covers both.*

ZAIUS33: You've got the parts? Great... I hope you've got some protective gear. The fumes can take you down.
...
ZAIUS38: Good, good. Please hurry, though... Our town needs what we get out of here.
...
ZAIUS40: Please hurry. The mine is our town's lifeblood.

## Town Directions
*Pointing the PC toward other NPCs.*

ZAIUS41: Well, the best person to talk to about that would be Marcus, over at the bank, or Steve, the greeter for the town.

## General Town Status
*A brief, measured answer. Cautiously optimistic.*

ZAIUS42: I'd have to say they're all right. Still... They could always be better.
...
*End of script — 40 recordable lines total (ZAIUS1–ZAIUS50, numbering non-sequential). Excluded from the count: ZAIUS17 and ZAIUS20 (engine macros, not recordable as written — see notes above), one float bark (ZAIUS37, "You bastard. You're going to die now.") which is a combat bark, not spoken dialogue, and one duplicate take (ZAIUS33 covers both msg 183 and 186). Tag numbers follow ascending message-ID order, not this document's topical grouping.*

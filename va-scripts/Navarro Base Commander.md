# Navarro Base Commander — Voice Actor Script
...
> Do NOT read any bracketed stage directions aloud (e.g. "[He chuckles]"). Lines marked PC are for context only.
...
*End of script — 25 lines total (**cmdr1**–**cmdr25**). Tag numbers follow ascending message-ID order, not this document's topical grouping.*

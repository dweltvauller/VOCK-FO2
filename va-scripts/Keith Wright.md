...
> If a line contains a stage direction like (Shakes head) or (Knocks on door behind him), attempt to make the noise when reasonable. Name each audio file after the tag, e.g. "Who are you?" is `keith1`.wav.
